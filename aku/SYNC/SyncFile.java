...
public class SyncFile extends AncientKemetFile {
    ...
    /*
     * public static void main(String[] args) { AncientKemetRegistry.loadRegister();
     * SyncFile file = new SyncFile("LOL.txt"); file.sending = true; SyncFile file2 = new
     * SyncFile("LOL2.txt"); file.writeData("WATGF OMFG".getBytes());
     *
     * file.progressIO(); System.out.println("fff: "+file.getBytesToSend().length);
     * file2.progressIO(); file2.bytesToWrite = file.getBytesToSend(); file2.progressIO();
     * file2.flushOut();
  }
     */
}
